...
import { CheckIcon, HelpCircleIcon, ScaleIcon, HeartIcon, CompassIcon, LightbulbIcon, ArrowLeft, ArrowRight, ArrowRightIcon} from "lucide-react"
...
export function Questionnaire({ thought, onComplete }: QuestionnaireProps) {
            ...
            >
              ...
              >
                <div className="flex items-center">
                  ...
                  />
                  <Label htmlFor={`isTrue-${option.value}`} className="ml-2 text-base cursor-pointer flex-grow">
                    {option.label}
                  </Label>
        ...
        <div className="space-y-8 mt-6">
          ...
          >
            <Slider
              ...
              max={10}
              step={1}
              onValueChange={(value) => handleAnswerChange("truthScale", value[0])}
              className="py-4"
    ...
    },
    {
      ...
      component: (
        <div className="mt-6">
          ...
          >
            <p>Ejemplos: ansiedad, miedo, tristeza, frustración, vergüenza, culpa...</p>
          </motion.div>
        </div>
      ),
    },
      ...
      component: (
        <div className="mt-6">
          ...
          <motion.div
            ...
            className="mt-4 text-xs text-muted-foreground"
          >
            <p>Ejemplos: experiencias pasadas, críticas recibidas, presión social, autocrítica...</p>
          </motion.div>
        </div>
      ),
    },
      ...
      component: (
        <div className="mt-6">
          ...
          <motion.div
            ...
            className="mt-4 text-xs text-muted-foreground"
          >
            <p>Piensa en cómo verías esta situación si le ocurriera a un amigo o desde otra perspectiva.</p>
          </motion.div>
        </div>
      ),
    },
  ...
  const handleAnswerChange = (field: keyof typeof answers, value: any) => {
  ...
  return (
    <div className="space-y-6 relative">
      ...
      >
        ...
        <div className="p-4 bg-accent/80 backdrop-blur-sm rounded-lg text-sm italic card-glow">{thought}</div>
      </motion.div>
        ...
        <AnimatePresence custom={direction} mode="wait">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="bg-primary/10 p-2.5 rounded-full" aria-hidden="true">
                {questions[currentQuestion].icon}
              </div>
              <h4 className="font-medium text-lg">{questions[currentQuestion].question}</h4>
            </div>
        ...
        <div className="flex justify-between pt-4">
          ...
          >
            <Button
              ...
              className="rounded-lg group"
              aria-label={currentQuestion < questions.length - 1 ? "Siguiente pregunta" : "Finalizar cuestionario"}
            >
