...
import { PlusCircle, Trash2, Calendar, Clock, Search, Loader2, FileText, AlertCircle, ArrowRight } from "lucide-react"
...
export function SavedThoughts({ onNewThought }: SavedThoughtsProps) {
  ...
  const loadThoughts = async () => {
    ...
    try {
      ...
      toast({
        title: "Error al cargar pensamientos",
        ...
        >
          {thoughts.length === 0 ? (
            <>
              ...
              <h3 className="text-lg font-medium mb-2">No hay pensamientos guardados</h3>
              <p className="text-muted-foreground mb-4">
                Comienza a procesar y guardar tus pensamientos para verlos aquí.
              </p>
              <Button onClick={onNewThought} className="rounded-lg group" aria-label="Crear nuevo pensamiento">
            ...
            <>
              ...
              <p className="text-muted-foreground">No hay pensamientos que coincidan con tu búsqueda.</p>
            </>
          )}
        </motion.div>
      ) : (
              ...
              {filteredThoughts.map((thought, index) => (
                ...
                >
                  <div className="flex justify-between items-start">
                        ...
                        >
                          <div className="truncate max-w-[250px]">
                            ...
                            <div className="flex items-center text-xs text-muted-foreground mt-1">
                              ...
                              <Clock className="h-3 w-3 ml-2 mr-1" aria-hidden="true" />
                    ...
                    <AlertDialog
                      open={isDeleteDialogOpen && thoughtToDelete === thought.id}
                      onOpenChange={(open) => {
                    ...
                    >
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Esta acción no se puede deshacer. Esto eliminará permanentemente este pensamiento de tu
                            historial.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
